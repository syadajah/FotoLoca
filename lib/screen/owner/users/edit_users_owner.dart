...
class EditUsersOwner extends StatefulWidget {
  final Map<String, dynamic> userData;

  const EditUsersOwner({super.key, required this.userData});

  @override
  State<EditUsersOwner> createState() => _EditUsersOwnerState();
}

class _EditUsersOwnerState extends State<EditUsersOwner> {
  ...
  void initState() {
    ...
    // Password dikosongin aja karena password dari DB gak ditampilin
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Apakah kamu yakin ingin menyimpan perubahan pada data admin ini?',
  ...
  Future<void> _prosesEditUser() async {
    ...
    try {
      final result = await UserServices().updateUser(
        ...
        // UBAH DISINI: Karena ini Owner, dia cuma bisa ngedit role Admin
        role: 'admin', 
      );
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Admin', // UBAH DISINI: Jadi Admin
