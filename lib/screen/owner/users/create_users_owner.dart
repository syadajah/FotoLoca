...
class CreateUsersOwner extends StatefulWidget {
  const CreateUsersOwner({super.key});

  @override
  State<CreateUsersOwner> createState() => CreateUsersOwnerState();
}

class CreateUsersOwnerState extends State<CreateUsersOwner> {
  ...
  // Role kita hardcode aja karena ini halaman khusus nambah admin
  ...
  Future<void> _simpanUser() async {
    ...
    final result = await UserServices().addUser(
      ...
      role: _role, // Otomatis jadi admin
    );
